...
export const buildSchema = (rawSchema: Object) => {
  ...
  try {
    ...
    listOfFields.forEach((fieldName) => {
      /**
       * field will be assigned the below value in the first iteration
       * and will be passed to the getFieldValidation function
       * { min: [2, 'Too short'], max: [50, 'Too long'], required: 'Required' }
      */
