...
const useSpeechRecognition = ({ handleSpeechEnd, onSpeechRecognitionResults }: Props) => {
  ...
  let speechRecognition: Object = window.SpeechRecognition && new window.SpeechRecognition();
