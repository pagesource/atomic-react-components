...
Pagination.propTypes = {
  ...
  showLastBtn: PropTypes.bool,
  showFirstBtn: PropTypes.bool,
  currentPageAria: PropTypes.string,
  paginationAriaLabel: PropTypes.string,
  nextButtonAria: PropTypes.string,
  previousButtonAria: PropTypes.string,
  firstButtonAria: PropTypes.string,
  lastButtonAria: PropTypes.string,
  currentPage: PropTypes.number,
  pageNeighbours: PropTypes.number,
  gotoPageAria: PropTypes.string,
};
