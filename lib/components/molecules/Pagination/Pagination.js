...
const Pagination = ({
  ...
  useEffect(() => {
    setDisabledFirstNdPrevious(activePage === 1);
    setDisabledNextAndLast(activePage === pageNumbers.length);
  }, [activePage]);
        ...
        <ul className="pagination">
          ...
          <>
            <PaginationList
              ...
              disabledFirstNdPrevious={disabledFirstNdPrevious}
              handleBackwardClick={handleBackwardClick}
              previousLabel={previousLabel}
              nextButtonAria={nextButtonAria}
              disabledNextAndLast={disabledNextAndLast}
