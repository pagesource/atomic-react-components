 ...
 */
const NavController = ({ navType, children, prevLabel, nextLabel }) => {
 ...
 */
const AnimationControl = ({ className, renderPlay, renderPause }) => {
 ...
 */
Carousel.SlideWrapper = ({ children, className }) => {
 ...
 */
Carousel.Slide = ({ children, id, className }) => {
 ...
 * Next Navigation.
 */
Carousel.Next = ({ children }) => <NavController navType="next">{children}</NavController>;

/**
 * Previous Navigation.
 */
Carousel.Prev = ({ children }) => <NavController navType="prev">{children}</NavController>;
...
NavController.propTypes = {
  navType: PropTypes.oneOf(['next', 'prev']).isRequired,
...
AnimationControl.propTypes = {
  ...
  renderPlay: PropTypes.func,
  renderPause: PropTypes.func,
};
...
Carousel.propTypes = {
  children: PropTypes.node.isRequired,
  slideTransitionTime: PropTypes.number,
  slideAnimationTime: PropTypes.number,
  autoplay: PropTypes.bool,
  controls: PropTypes.bool,
  dots: PropTypes.bool,
  dotsStyle: PropTypes.objectOf(PropTypes.object).isRequired,
  renderSlideThumb: PropTypes.objectOf(PropTypes.object).isRequired,
  className: PropTypes.string.isRequired,
  navBtnStyle: PropTypes.objectOf(PropTypes.object).isRequired,
  legacy: PropTypes.objectOf(PropTypes.object).isRequired,
...
Carousel.SlideWrapper.propTypes = {
