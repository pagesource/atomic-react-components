...
const ToastStyles = css`
  ...
  ${props =>
    props.placement === `top-left`
      ? `top: 30px;left: 30px;animation: var(--animation-slide-right);`
      : ``};
  ${props =>
    props.placement === `top-right`
      ? `top: 30px;right: 30px;animation: var(--animation-slide-bottom);`
      : ``};
  ${props => (props.placement === `bottom-left` ? `bottom: 30px;left: 30px;` : ``)};
  ${props =>
    props.placement === `bottom-right`
      ? `bottom: 30px;right: 30px;animation: var(--animation-slide-left);`
      : ``};
  ${props =>
    props.placement === `center-center`
      ? `top: calc(50% - 40px);left: calc(50% - 200px);animation: var(--animation-slide-up);`
      : ``};
  ...
  ${props =>
    props.placement === `right-center`
      ? `right: 30px;top: calc(50% - 40px);animation: var(--animation-slide-left);`
      : ``};
  ...
  .toast-dismiss {
    ...
    -webkit-animation: dismiss-anim ${props => `${props.autoDismissTimeout / 1000}.5s`} ease-in-out;
  }
