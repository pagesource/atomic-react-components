...
storiesOf('Molecules/Toast', module)
  ...
  .add('Toast Info', () => (
    <Toast variation="info" {...defaultToast}>
      <Icon id="info" title="information icon" color={theme.colors.CTA_INFO} />
      <Para>Wow so easy !</Para>
    </Toast>
  ))
  .add('Toast Success', () => (
    <Toast variation="success" {...defaultToast}>
      <Icon id="success" title="success icon" color={theme.colors.CTA_SUCCESS} />
      <Para>Wow so easy !</Para>
    </Toast>
  ))
  .add('Toast Warning', () => (
    <Toast variation="warning" {...defaultToast}>
      <Icon id="warning" title="warning icon" color={theme.colors.CTA_WARNING} />
      <Para>Wow so easy !</Para>
    </Toast>
  ))
  .add('Toast Error', () => (
    <Toast variation="error" {...defaultToast}>
      <Icon id="error" title="error icon" color={theme.colors.CTA_ERROR} />
      <Para>Wow so easy !</Para>
    </Toast>
  ))
