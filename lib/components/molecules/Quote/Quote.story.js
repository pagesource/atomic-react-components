...
import { defaultQuote, noAuthorQuote, noCompanyQuote, allFieldseparatorQuote } from './Quote.mock';
  ...
  chapters: [
    {
      sections: [
        {
          sectionFn: () => <QuoteVanilla {...defaultQuote} />,
          options: {
            showSource: true,
    ...
    {
      title: 'Quote with all fields and | as separator of company and author',
      sections: [
        {
          title: 'With all fields',
          sectionFn: () => <Quote {...allFieldseparatorQuote} />,
        },
      ],
    },
    {
