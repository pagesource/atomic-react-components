...
describe('<Typeahead />', () => {
  ...
  test('should render the list items with `role="option"`', () => {
    MountedTypeaheadComponent.find('Input')
      .first()
      .simulate('change', {
        target: { value: 'all' },
  ...
  test('should render the list items with `aria-selected`', () => {
    MountedTypeaheadComponent.find('Input')
      .first()
      .simulate('change', {
        target: { value: 'all' },
  ...
  test('should render the list items with `id="selectedOption"`', () => {
    MountedTypeaheadComponent.find('Input')
      .first()
      .simulate('change', {
        target: { value: 'all' },
